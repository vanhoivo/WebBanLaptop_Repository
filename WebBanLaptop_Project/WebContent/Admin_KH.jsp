    ...
    <div id="Middle">
        <div id="Left">
            <nav class="nav flex-column">
                ...
                <a class="nav-link active bg-primary text-white" href="khachhang">
        ...
        <div id="Right">
            <h3><i class="fas fa-user-tie"></i>QUẢN LÍ KHÁCH HÀNG</h3>
            <hr />
            ...
            <div id="Feature">
                <form class="form-inline" autocomplete="on" action="/search" method="post">
                    ...
                    <div class="ml-auto">                  
                        <a href="khachhang"><button class="ml-auto btn btn-success mb-2" type="button" name="btnReload">
                    ...
                    <table class="table table-striped table-hover border border-primary table-bordered">
                        ...
                        <c:forEach var="kh" items="${listKhachHang }">
								...
								<tr>
									...
									<td><a href="DeleteKH?makh=${kh.makh }"><i
											class="fas fa-trash-alt"></i></a></td>
									<td><a href="GetKH?makh=${kh.makh }"><i class="fas fa-edit"></i></a></td>
								</tr>
							</c:forEach>
                        ...
                        <div class="modal-body">
                            <form autocomplete="on" action="InsertNV" method="post" id="formAdd">
                                <div class="form-group row">
                                    <label for="InputMaKH" class="col-sm-3 col-form-label">Mã Khách Hàng</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="InputMaKH" name="MaKH"
                                            placeholder="Mã Khách Hàng" required>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="InputTenKH" class="col-sm-3 col-form-label">Tên Khách Hàng</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="InputTenKH" name="TenKH"
                                ...
                                <div class="form-group row">
                                    <label for="InputSoDT" class="col-sm-3 col-form-label">Số điện thoại</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="InputSoDT" name="SoDT"
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <a href="khachhang"><button type="button" class="close" name="btnCloseEditHeader" >&times;</button></a>
                        </div>

                        <div class="modal-body">
                            <form autocomplete="on" action="UpdateKH" method="post" id="formAdd">
                                <div class="form-group row">
                                    <label for="InputMaKH" class="col-sm-3 col-form-label">Mã Khách Hàng</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="InputMaKH" name="MaKH"
                                            placeholder="Mã Khách Hàng" readonly value="${khachhang.makh }">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="InputTenKH" name="TenKH"
                                            placeholder="Tên Khách Hàng" autofocus value="${khachhang.tenkh }">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="InputDiaChi" name="DiaChi"
                                            placeholder="Địa Chỉ" value="${khachhang.diachi }">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="InputSoDT" name="SoDT"
                                            placeholder="Số điện thoại" value="${khachhang.sodienthoai }">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="InputTenDangNhap" class="col-sm-3 col-form-label">Tên đăng nhập</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="TenDangNhap" name="TenDangNhap"
                                            placeholder="TenDangNhap" value="${khachhang.tendangnhap}" readonly>
                                    </div>
                                </div>

                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" name="btnSaveAdd" onclick="newFunction2()"><i class="far fa-save"></i>Lưu</button>
                            <a href="khachhang"><button type="button" class="btn btn-danger" name="btnCancelAdd" ><i
