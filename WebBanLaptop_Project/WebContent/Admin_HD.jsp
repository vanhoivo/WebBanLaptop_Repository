...
<body onload="StartTime()">
    ...
    <div id="Middle">
            ...
            <nav class="nav flex-column">
                ...
                <div class="dropdown">
                    ...
                    <div class="collapse dropdown-content" id="BanHang">
                        <a style="margin-left: 30px;" class="nav-link active bg-primary text-white" href="hoadon">
        ...
        <div id="Right">
            <h3><i class="fas fa-user-tie"></i>QUẢN LÍ HÓA ĐƠN</h3>
            <hr />
            ...
            <div id="Feature">
                <form class="form-inline" autocomplete="on" action="/search" method="post">
                    ...
                    <div class="ml-auto">
                        <a href="hoadon"><button class="ml-auto btn btn-success mb-2" type="button" name="btnReload">
                    ...
                    <table class="table table-striped table-hover border border-primary table-bordered">
                        ...
                        <thead class="thead-dark">
                            <tr>
								...
								<th>Tổng Tiền</th>
                                <th>
                                    <i title="Chọn Tất cả" class="fas fa-check-circle"></i></th>
                        ...
                        <c:forEach var="hd" items="${listHoaDon }">
								<tr>
									...
									<td>${hd.makh }</td>
									<td>${hd.ngaylaphd }</td>
									<td>${hd.ngaynhanhang }</td>
									<td>${hd.tongtien }</td>
									<td><i class="fas fa-check-circle"></i></td>
									<td><a href="DeleteHD?mahd=${hd.mahd }"><i
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="InputMaKH" name="MaKH"
                                            placeholder="Mã Khách Hàng" autofocus>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="InputNgayLapHD" class="col-sm-3 col-form-label">Ngày Lập </label>
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control" id="InputNgayLapHD" name="NgayLapHD"
                                            placeholder="">
                                    </div>
                                </div>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <a href="hoadon"><button type="button" class="close" name="btnCloseEditHeader" >&times;</button></a>
                        </div>
                        ...
                        <div class="modal-body">
                            <form autocomplete="on" action="UpdateHD" method="post" id="formAdd">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="InputMaHD" name="MaHD"
                                            placeholder="Mã Hóa Đơn" required value="${hoadon.mahd }">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="InputMaKH" name="MaKH"
                                            placeholder="Mã Khách Hàng" autofocus value="${hoadon.makh }">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control" id="InputNgayLapHD" name="NgayLapHD"
                                            placeholder="" value="${hoadon.ngaylaphd }">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="InputTongTien" class="col-sm-3 col-form-label">Tổng tiền</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="InputTongTien" name="TongTien"
                                            placeholder="Tổng tiền" value="${hoadon.tongtien }" readonly>
                                    </div>
                                </div>
                               
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" name="btnSaveAdd" onclick="newFunction2()"><i class="far fa-save"></i>Lưu</button>
                            <a href="hoadon"><button type="button" class="btn btn-danger" name="btnCancelAdd" data-dismiss="modal"><i
