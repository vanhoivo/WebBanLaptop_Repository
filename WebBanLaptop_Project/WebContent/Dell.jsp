			...
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3"
				...
				<div class="list-group">
					<a href="" class="list-group-item"
						style="background-color: #44bbb6;">DANH MỤC</a> <a href=""
						class="list-group-item list-group-item-info">ASUS</a> <a href=""
						class="list-group-item list-group-item-info">DELL</a> <a href=""
						class="list-group-item list-group-item-info">HP</a> <a href=""
						class="list-group-item list-group-item-info">MSI</a> <a href=""
						class="list-group-item list-group-item-info">MACBOOK</a>
				</div>
			</div>
			<!-- /end catalog -->
			<!-- /start slide -->
					...
					<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 product_item">
						<div class="thumbnail">
							...
							<div class="caption text-center">
								...
								<p>ASUS AX</p>
								<p>
									<a href="Cart.jsp" class="btn btn-primary">Chọn mua</a> <a
										href="product.jsp" class="btn btn-default">Chi tiết</a>
								</p>
							</div>
						</div>
					</div>
					<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 product_item">
						<div class="thumbnail">
							...
							<div class="caption text-center">
								...
								<p>ASUS AX</p>
								<p>
									<a href="#" class="btn btn-primary">Chọn mua</a> <a href="#"
