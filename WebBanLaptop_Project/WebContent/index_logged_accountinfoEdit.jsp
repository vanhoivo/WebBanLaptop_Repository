		...
		<div id="maincontent" class="col-xs-9 col-sm-9 col-md-9 col-lg-9" style="padding-right: 0px;padding-left: 0px;">
            ...
            <form class="form-horizontal" action="UpdateKH" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="hoten" placeholder="Họ tên" name="TenKH" autofocus value="${khachhang.tenkh }" >
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="email">Email:</label>
                    <div class="col-sm-10">
                    <input type="email" class="form-control" id="email" placeholder="Email" name="Email" value="${khachhang.email }" >
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="dienthoai">Điện thoại:</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="dienthoai" placeholder="Điện thoại" name="SoDT" value="${khachhang.sodienthoai }" >
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="diachi">Địa chỉ:</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="diachi" placeholder="Địa chỉ" name="DiaChi" value="${khachhang.diachi }">
                    </div>
                </div>
