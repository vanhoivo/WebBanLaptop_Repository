	...
	<div class="row" style="height: 650px;">
		...
		<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" style="padding-left: 0px;">
			<div class="list-group">
				...
				<a href="" class="list-group-item list-group-item-info"><span class="glyphicon glyphicon-list"></span> Đơn hàng của tôi</a>			
		...
		<div id="maincontent" class="col-xs-9 col-sm-9 col-md-9 col-lg-9" style="padding-right: 0px;padding-left: 0px;">
            ...
            <form class="form-horizontal" action="ChangePassTKClient" method="post">
                <div class="form-group">
                    <label class="control-label col-sm-2" for="pwdold">Mật khẩu cũ:</label>
                    <div class="col-sm-10"> 
                    <input type="password" class="form-control" id="pwdold" name="MatKhauCu"placeholder="Mật khẩu cũ">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="pwdnew">Mật khẩu mới:</label>
                    <div class="col-sm-10"> 
                    <input type="password" class="form-control" id="pwdnew" name="MatKhauMoi"placeholder="Mật khẩu mới">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="pwdnewre">Nhập lại mật khẩu mới:</label>
                    <div class="col-sm-10"> 
                    <input type="password" class="form-control" id="pwdnewre" name="LapLaiMatKhauMoi" placeholder="Nhập lại mật khẩu mới">
                    </div>
                </div>
                ...
                <div class="form-group"> 
                    ...
                    <a href="GetKHClient"><button type="button" class="btn btn-primary">Hủy</button></a>
                    </div>
                </div>
            </form>
		</div>
