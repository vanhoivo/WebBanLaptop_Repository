...
<body>
	...
	<div class="container">
		<div class="row">
			<iframe
				src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.47984031965!2d106.76982351428751!3d10.85106166077999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3175270ad28d48ab%3A0xa6c02de0a7c40d6c!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBTxrAgcGjhuqFtIEvhu7kgdGh14bqtdCBUcC4gSOG7kyBDaMOtIE1pbmg!5e0!3m2!1svi!2s!4v1541582382130"
		...
		<div class="row">
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<div class="col-inner">
					<h3>
						<strong>PLH STORE</strong>
					</h3>
					<p>
						<strong>Địa chỉ: </strong><span style="color: #0000ff;">Số
							1, Võ Văn Ngân, phường Linh Chiểu, quận Thủ Đức, TP.HCM</span>
					</p>
					<p>
						<strong>Phone:</strong>&nbsp;<strong><span
							style="color: #ff0000;">076 767 767</span></strong>
					</p>
					<p>
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<form>
					<label style="width: 100%"> <strong>Họ tên:</strong> <br>
						<input style="width: 100%; height: 30px" type="text" name="hoten">
					</label> <label style="width: 100%"> <strong>Email:</strong> <br>
						<input style="width: 100%; height: 30px" type="text" name="hoten">
					</label> <label style="width: 100%"> <strong>Số điện
							thoại:</strong> <br> <input style="width: 100%; height: 30px"
						type="text" name="hoten">
					</label> <label style="width: 100%"> <strong>Nội dung liên
							hệ:</strong> <br> <textarea rows="8" style="width: 100%"></textarea>
					</label>
