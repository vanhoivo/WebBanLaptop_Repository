 ...
 */
@WebServlet("/GetKHClient")
public class GetKHClient extends HttpServlet {
	...
	private void getKhachHang(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("index_logged_accountinfo.jsp");
