...
/**
 * Servlet implementation class ChangePassTK
 */
@WebServlet("/ChangePassTK")
public class ChangePassTK extends HttpServlet {
	...
	protected void changepassTK(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException,SQLException{
		...
		String color = "red";
		if (lgDAO.DangNhapTaiKhoanAdmin(TenDangNhap, MatKhauCu))
		{
